...
public class NanoHTTPD
{
	...
	public static class NanoHTTPD_ {
		private static final NanoHTTPD INSTANCE = new NanoHTTPD();
	}
	
	public static NanoHTTPD getInstance() {
		return NanoHTTPD_.INSTANCE;
	}
	...
	//public NanoHTTPD(String bindAddress, int port, File wwwroot ) throws IOException
	public void Start(String bindAddress, int port, File wwwroot ) throws IOException
	{
		if ( isActive() ) {
			Stop();
		}
		...
		if ( bindAddress != null ) {
			...
			myServerSocket.bind(new InetSocketAddress(bindAddress,myTcpPort ));
		} else 
			myServerSocket = new ServerSocket(myTcpPort);
		
		Log.v("HTTPD","binded to " + myServerSocket.getInetAddress().getHostAddress() + ":" + String.valueOf(port));
